...
const METADATA = {
  title: 'Angular2 - TypeScript - Webpack Starter',
  baseUrl: '/',
  host: 'localhost',
  port: 3000,
  ENV: ENV,
...
module.exports = {
  ...
  module: {
    ...
    loaders: [
      ...
      // CSS loaders
      // See: https://github.com/webpack/style-loader, https://github.com/webpack/css-loader,
      // https://github.com/postcss/postcss-loader
      {test: /\.css$/, exclude: /node_modules/, loader: ExtractTextPlugin.extract('style-loader', 'css-loader!postcss-loader')},
      
      // Sass Loader
      // See: https://github.com/jtangelder/sass-loader 
      {test: /\.scss$/, exclude: /node_modules/, loader: ExtractTextPlugin.extract('style-loader', 'css-loader!postcss-loader!sass-loader')},
  ...
  plugins: [
    ...
    // Extract text from a bundle into a seperate file
